...
const PALABRAS_CLAVE: Record<CategoriaAjustesId, string[]> = {
  ...
  whatsapp: ['whatsapp', 'wasap', 'wsp', 'mensajes', 'chat', 'telefono', 'numero', 'celular', 'comandos', 'vincular'],
  informes: ['informes', 'informe', 'reporte', 'reportes', 'pdf', 'descargar', 'exportar', 'estadisticas', 'rendimiento', 'resumen', 'semanal', 'mensual', 'anual', 'progreso'],
